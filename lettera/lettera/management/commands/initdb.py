...
"annotation", "b", "ar", "anzesi", "bb", "be", "bi", "bil", "bo", "bu", "c",
"ca", "can", "cap", "ce", "cer", "ch", "eo", "er", "enza", "fo", "g", "à", "f",
"segu", "vu", "sig", "avvel", "ri", "seu", "vuo", "ga", "ge", "gg ", "ggono",
"ghe", "gu", "gi", "f", "ea", "eam", "iacozo", "ian", "ibi", "ic", "id", "ie",
...
"nte", "nu", "possessivo", "cos", "com", "hi", "gentiè", "empti", "ellissi",
"por", "r", "ran", "ra", "got", "gl", "go", "gra", "avi", "ese", "deranno",
...
def split_contraction(string, start, end):
  ...
  if len(splitname) == 3:
    ...
    return [(front+"'", start, start+len(front)+1), 
            (middle+"'", start+len(front)+2, start+len(front)+2+len(middle)+1), 
