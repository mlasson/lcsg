...
class Command(BaseCommand):
  ...
  def handle(self, *args, **options):
    print('Checking families that families are not empty and contains at least one occurrence')
    all_families = Family.objects.annotate(occurrences=Count('word__occurrence')).order_by('pk')
